...
with open(datafile, 'w', encoding='utf-8') as outputfile:
    ...
    with open("../data/JoeyConversation",'r') as joey:
        for line in joey:
            lines = line.split("----")
            lines[1] = lines[1][0:-2]
...
with open("../model/encoder.pt",'wb') as f:
    torch.save(encoder,f)
with open("../model/decoder.pt",'wb') as f:
    torch.save(decoder,f)

with open("../model/encoder.pt", 'rb') as f:
    myencoder = torch.load(f)
with open("../model/decoder.pt", 'rb') as f:
    mydecoder = torch.load(f)

myencoder.eval()
mydecoder.eval()
# Initialize search module
searcher = GreedySearchDecoder(myencoder, mydecoder)

# Begin chatting (uncomment and run the following line to begin)
evaluateInput(myencoder, mydecoder, searcher, voc)
